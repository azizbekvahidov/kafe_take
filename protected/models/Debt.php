...
class Debt extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('expense_id', 'numerical', 'integerOnly'=>true),
			array('d_date', 'safe'),
			/*
			//Example username
			...
			array('debt_id, d_date, expense_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            'expense'=>array(self::BELONGS_TO,'Expense','expense_id'),
		);
	}
	...
	public function beforeSave() 
    {
        ...
        {           
        	...
        	//$from=DateTime::createFromFormat('d/m/Y',$this->d_date);
        	//$this->d_date=$from->format('Y-m-d');
    ...
    public function afterFind()    {
        	...
        	// NOT SURE RUN PLEASE HELP ME -> 
        	//$from=DateTime::createFromFormat('Y-m-d',$this->d_date);
        	//$this->d_date=$from->format('d/m/Y');
