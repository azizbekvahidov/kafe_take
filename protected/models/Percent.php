...
class Percent extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('settings_id, percent_date, percent', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('percent_date',$this->percent_date,true);
	...
	public function beforeSave() 
    {
        ...
        {           
        	...
        	//$from=DateTime::createFromFormat('d/m/Y',$this->percent_date);
        	//$this->percent_date=$from->format('Y-m-d');
    ...
    public function afterFind()    {
        	...
        	// NOT SURE RUN PLEASE HELP ME -> 
        	//$from=DateTime::createFromFormat('Y-m-d',$this->percent_date);
        	//$this->percent_date=$from->format('d/m/Y');
